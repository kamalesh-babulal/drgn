 ...
 *
 * @param[in] builder Builder containing members.
 ...
 * On success, this takes ownership of @p builder.
 *
 * @param[in] builder Builder containing enumerators.
 ...
 * On success, this takes ownership of @p builder.
 *
 * @param[in] builder Builder containing parameters.
